            ...
            var newList = {
                ...
                dragStart: function (e) {
                    ...
                    if (!opts.dragBetween) {
                        var containerHeight =
                            $(list.container).outerHeight() == 0
                                ? Math.max(1, Math.round(0.5 + (list.getItems().length * list.draggedItem.outerWidth()) / $(list.container).outerWidth())) * list.draggedItem.outerHeight()
                    ...
                    if (opts.tagName === 'td') {
                        ...
                        $('<table id="' + listTable.id + '" style="border-width: 0px;" class="dragSortItem ' + listTable.className + '"><tr></tr></table>')
                            .appendTo('body')
                            .children()
