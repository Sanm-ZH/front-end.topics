...
(function (factory) {
    ...
    $.fn.arrangeable = function (options, callbackFn) {
        var dragging = false;
        var $clone;
        var dragElement;
        ...
        function dragMoveHandler(e) {
            ...
            } else if (Math.abs(dragDistanceX) > DRAG_THRESHOLD || Math.abs(dragDistanceY) > DRAG_THRESHOLD) {
        ...
        function dragEndHandler(e) {
            if (dragging) {
                ...
                $(dragElement)
                    .parent()
                    .trigger(dragEndEvent, [$(dragElement)]);
                // 回调
                callbackFn('end', dragElement);
            }
